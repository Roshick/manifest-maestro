module github.com/Roshick/manifest-maestro

go 1.23

require (
	github.com/Roshick/go-autumn-configloader v0.2.0
	github.com/Roshick/go-autumn-slog v0.3.1
	github.com/Roshick/go-autumn-synchronisation v0.7.5
	github.com/Roshick/go-autumn-vault v0.1.1
...
require (
	...
	github.com/StephanHCB/go-autumn-restclient v0.9.1 // indirect
